...
2. Standard engineering mathematics formulas for Laplace transforms
3. Standard Fourier series derivations for periodic functions
4. Python scientific-computing documentation for NumPy and SciPy
